import { runDiputadosGacetaIngestion } from "../ingestion/adapters/diputados-gaceta/index.js";

async function main() {
  const result = await runDiputadosGacetaIngestion({
...
void main().catch((error) => {
  console.error("Diputados Gaceta ingestion failed", error);
  process.exitCode = 1;
});
